...
public static class Program
{
    ...
    static IEnumerable<string> ParseCorpus()
    {
        var v = new List<string>
        {
            ...
            "  12  ", "\t12\t", "12 ", " 12",
            "(1.5)", "1.5-", "-1.5", "1.5+",
            "$1,234.56", "$-1234", "-$1234", "1234$", "($1,234.56)", "(1,234.56)",
            "1e5", "1E5", "1e+5", "1e-5", "1E-28", "1e28", "1e29", "1e-29",
            "1.5e3", "-1.5e-3", "1.5E+03", "0e0", "0e10", "0e-10",
            "0000000000000000000000000000001",

            // rounding at the 29th significant digit -- these decide banker's
            // rounding in the parser, which is where a reimplementation drifts
            "1.00000000000000000000000000005",
            "1.00000000000000000000000000015",
            "1.00000000000000000000000000025",
            "1.00000000000000000000000000035",
            "0.500000000000000000000000000050",
            "0.5000000000000000000000000000500000001",
            "1.0000000000000000000000000000499999999",
            "79228162514264337593543950335.5",
            "7.92281625142643375935439503355",

            // scale preservation
            "1.10", "1.100", "1.1000", "-1.10", "0.00", "-0.00", "0.000000000000000000000000000",
            "100.00", "0.0000000000000000000000000000",

            // malformed -- every one of these must fail
            "", " ", "\t", ".", "-", "+", "--1", "1-2", "1.2.3", "1..2",
            "abc", "12abc", "ysaidufljasdf", "0x10", "1_000",
            "NaN", "Infinity", "-Infinity", "1e", "e5", "1e+", "1e-", "1e999999",
            "(1.5", "1.5)", "()", "1,,234", ",", "1 234", "- 1", "1 -",
            "$", "()1", "1()", "+-1", "-+1", "1.5-+", "((1))",
        };
        return v;
    }
